...
public class Docteur implements Serializable {
	...
	private String Nom;
        ...
        public Docteur(Long id, int Age, String Nom, String Prenom, String Specialite, String Genre, String Ville, String Email, int NombrePatientParJour, int DebutTravaille, int FinTravaille) {
            this.id = id;
            this.Age = Age;
            this.Nom = Nom;
            this.Prenom = Prenom;
        ...
        public String toString() {
            return "Docteur{" + "id=" + id + ", Age=" + Age + ", Nom=" + Nom + ", Prenom=" + Prenom + ", Specialite=" + Specialite + ", Genre=" + Genre + ", Ville=" + Ville + ", Email=" + Email + ", NombrePatientParJour=" + NombrePatientParJour + ", DebutTravaille=" + DebutTravaille + ", FinTravaille=" + FinTravaille + '}';
        }
